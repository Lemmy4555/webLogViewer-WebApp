...
module.exports = function (options) {
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        "Components": helpers.shared("components"),
        "Utils": helpers.shared("utils"),
        "Constants": helpers.shared("constants"),
        "Logger": helpers.shared("logger"),
        "Handlers": helpers.shared("handlers"),
        "Services": helpers.shared("services"),
        "Helpers": helpers.shared("helpers"),
        "Models": helpers.shared("models"),
        "Jobs": helpers.shared("jobs"),
        "Images": helpers.src("assets/img")
      },
    },
    ...
    module: {
      ...
      rules: [
         ...
         * 
         * Allows to import json in scss files
         *
         */
        {
          test: /\.scss$/,
